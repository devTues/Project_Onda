...
<body>
	<%
		...
		List<MenuDTO> drinkList = (List<MenuDTO>) request.getAttribute("drinkList");
	%>
				...
				<fieldset>
					...
					<ul class="cate_list">
						...
						<li><input type="radio" style='vertical-align: middle'
							name="category_1" id="category_all" checked="checked"> 
							<label for="category_all">모두보기</label></li>

						<li><input type="radio" style='vertical-align: middle;'
							name="category_1" id="category_1"> <label
							for="category_1">카테고리1</label></li>

						<li><input type="radio" style='vertical-align: middle;'
							name="category_1" id="category_2"> <label
							for="category_2">카테고리2</label></li>
